...
$foo1 = $icl->get( 'MonkeyLoader\Foo' );
var_dump( $foo1 );
echo ( get_class( $foo1 ) === 'MonkeyLoader\Foo' ) ? "\e[0;32mPASS\e[0m\n" : "\e[0;31mFAIL\e[0m\r\n";
echo 'Memory Usage: ', memory_get_usage(), "\r\n";
unset( $foo1 );

echo "Getting a Foo object in the MonkeyLoader namespace.\r\n";
// Should give me another Foo object.
$foo2 = $icl->get( 'MonkeyLoader\Foo' );
var_dump( $foo2 );
echo ( get_class( $foo2 ) === 'MonkeyLoader\Foo' ) ? "\e[0;32mPASS\e[0m\n" : "\e[0;31mFAIL\e[0m\r\n";
echo 'Memory Usage: ', memory_get_usage(), "\r\n";
unset( $foo2 );
...
var_dump( $foo3 );
echo ( get_class( $foo3 ) === 'MonkeyLoader\Foo' ) ? "\e[0;32mPASS\e[0m\n" : "\e[0;31mFAIL\e[0m\r\n";
echo 'Memory Usage: ', memory_get_usage(), "\r\n";
unset( $foo3 );

echo "Getting a Foo1 object in the MonkeyLoader namespace.\r\n";
// This should now construct a Foo1 Object!
$foo4 = $icl->get( 'MonkeyLoader\Foo' );
var_dump( $foo4 );
echo ( get_class( $foo4 ) === 'MonkeyLoader\Foo1' ) ? "\e[0;32mPASS\e[0m\n" : "\e[0;31mFAIL\e[0m\r\n";
echo 'Memory Usage: ', memory_get_usage(), "\r\n";
unset( $foo4 );
...
var_dump( $foo5 );
echo ( get_class( $foo5 ) === 'MonkeyLoader\Foo1' ) ? "\e[0;32mPASS\e[0m\n" : "\e[0;31mFAIL\e[0m\r\n";
echo 'Memory Usage: ', memory_get_usage(), "\r\n";
